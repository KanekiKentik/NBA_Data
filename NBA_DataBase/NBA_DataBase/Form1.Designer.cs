namespace NBA_DataBase
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            label15 = new Label();
            label14 = new Label();
            pdata_College = new TextBox();
            label13 = new Label();
            pdata_Country = new TextBox();
            label12 = new Label();
            pdata_Weight = new TextBox();
            label11 = new Label();
            pdata_Height = new TextBox();
            label10 = new Label();
            pdata_DraftRN = new TextBox();
            label9 = new Label();
            pdata_DraftYear = new TextBox();
            label8 = new Label();
            pdata_Jersey = new TextBox();
            label7 = new Label();
            pdata_PositionBox = new TextBox();
            label6 = new Label();
            pdata_TeamBox = new TextBox();
            pdata_LName = new TextBox();
            ...
            panel1.Controls.Add(switchFormButton);
            panel1.Controls.Add(pictureBox1);
            panel1.Controls.Add(label16);
            panel1.Controls.Add(label15);
            panel1.Controls.Add(label14);
            panel1.Controls.Add(pdata_College);
            panel1.Controls.Add(label13);
            panel1.Controls.Add(pdata_Country);
            panel1.Controls.Add(label12);
            panel1.Controls.Add(pdata_Weight);
            panel1.Controls.Add(label11);
            panel1.Controls.Add(pdata_Height);
            panel1.Controls.Add(label10);
            panel1.Controls.Add(pdata_DraftRN);
            panel1.Controls.Add(label9);
            panel1.Controls.Add(pdata_DraftYear);
            panel1.Controls.Add(label8);
            panel1.Controls.Add(pdata_Jersey);
            panel1.Controls.Add(label7);
            panel1.Controls.Add(pdata_PositionBox);
            panel1.Controls.Add(label6);
            panel1.Controls.Add(pdata_TeamBox);
            panel1.Controls.Add(pdata_LName);
            ...
            switchFormButton.Location = new Point(387, 294);
            switchFormButton.Name = "switchFormButton";
            switchFormButton.Size = new Size(151, 67);
            switchFormButton.TabIndex = 27;
            switchFormButton.Text = "Teams database";
            ...
            label9.TabIndex = 13;
            label9.Text = "Draft Round/Number";
            // 
            // pdata_DraftYear
            // 
            ...
            label1.Name = "label1";
            label1.Size = new Size(485, 62);
            label1.TabIndex = 0;
            label1.Text = "NBA players DataBase";
            // 
            // label2
            // 
            ...
            label2.TabIndex = 2;
            label2.Text = "Enter player`s name:";
            // 
            // searchBox
            // 
            searchBox.BackColor = Color.FromArgb(194, 194, 1);
            searchBox.Location = new Point(13, 121);
            ...
            // playerBox
            // 
            playerBox.ForeColor = Color.Olive;
            playerBox.FormattingEnabled = true;
            playerBox.ItemHeight = 15;
            playerBox.Location = new Point(13, 150);
            playerBox.Name = "playerBox";
            playerBox.Size = new Size(220, 289);
            playerBox.TabIndex = 4;
            playerBox.SelectedIndexChanged += playerBox_SelectedIndexChanged;
            // 
            // Form1
            // 
        ...
        private TextBox pdata_TeamBox;
        private Label label8;
        private TextBox pdata_Jersey;
        private Label label7;
        private TextBox pdata_PositionBox;
        private TextBox pdata_DraftYear;
        private TextBox pdata_DraftRN;
        private Label label9;
        private TextBox pdata_Country;
        private Label label12;
        private TextBox pdata_Weight;
        private Label label11;
        private TextBox pdata_Height;
        private Label label10;
        private TextBox pdata_College;
